...
def _node(node_id: str = "1727", **overrides) -> NodeState:
    ...
    stats = {
        ...
        "traffic_backbone_wg_rx": 5000,
        "traffic_backbone_wg_tx": 6000,
        "traffic_backbone_fastd_rx": 0,
        "traffic_backbone_fastd_tx": 0,
        "airtime_2g_busy": 10,
...
class NodeMetricsTest(unittest.TestCase):
    ...
    def test_emits_underscore_names_and_labels(self) -> None:
        ...
        for name in (
            ...
            "node_traffic_backbone_wg_rx_bytes",
            "node_traffic_backbone_wg_tx_bytes",
            "node_traffic_backbone_fastd_rx_bytes",
            "node_traffic_backbone_fastd_tx_bytes",
            "node_clients_wifi24",
            "node_clients_wifi5",
            "node_clients_total",
            "node_load",
